    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-1">Sign in to your FinanceBuddy account</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-card">
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <button className="h-10 rounded-lg border border-border bg-background text-foreground text-sm font-medium hover:bg-muted transition-colors flex items-center justify-center gap-2">
              ...
              <button className="h-10 rounded-lg border border-border bg-background text-foreground text-sm font-medium hover:bg-muted transition-colors flex items-center justify-center gap-2">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M16.365 1.43c0 1.14-.493 2.27-1.177 3.08-.744.9-1.99 1.57-2.987 1.57-.18 0-.36-.02-.53-.06-.01-.18-.04-.56-.04-.95 0-1.15.572-2.27 1.206-2.98.804-.94 2.142-1.64 3.248-1.68.03.13.05.28.05.44zm4.565 17.6c-.413.96-.612 1.388-1.145 2.232-.744 1.18-1.792 2.648-3.093 2.664-1.155.014-1.45-.755-3.018-.744-1.567.01-1.89.762-3.047.748-1.3-.016-2.283-1.347-3.028-2.528-2.082-3.3-2.3-7.18-.755-9.24 1.096-1.46 2.83-2.316 4.406-2.316 1.638 0 2.67.78 4.025.78 1.316 0 2.118-.78 4.015-.78 1.396 0 2.938.76 4.03 2.07-3.54 1.94-2.968 6.986.61 8.912z"/></svg>
                Apple
              </button>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          Don't have an account? <button onClick={() => navigate("/register")} className="text-primary font-medium hover:underline">Sign up</button>
        </p>
      </div>
    </div>
  );
